...
// Базовый абстрактный класс Shape (из задания 4 на уроке)
...
console.log(`Круг: площадь = ${coloredCircle.calculateArea().toFixed(2)}, цвет = ${coloredCircle.color}`);
console.log(`Прямоугольник: площадь = ${coloredRectangle.calculateArea()}, цвет = ${coloredRectangle.color}`);
