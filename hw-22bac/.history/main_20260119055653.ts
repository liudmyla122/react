...
console.log(`\nРасчет кредита:`)
console.log(`Сумма кредита: ${loanAmount.toLocaleString('eu-€')} евро`)
console.log(`Годовая ставка: ${annualRate}%`)
console.log(`Срок кредита: ${loanTerm} месяцев`)
console.log(`Ежемесячный платеж: ${monthlyPayment.toLocaleString('eu-€')} евро`)
...
console.log(`Доход: ${income.toLocaleString('eu-€')} евро`)
console.log(`Ставка налога: ${taxRate}%`)
console.log(`Сумма налога: ${tax.toLocaleString('eu-€')} евро`)
console.log(`Доход после налога: ${(income - tax).toLocaleString('eu-€')} евро`)
