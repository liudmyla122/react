...
console.log(`\nРасчет кредита:`)
console.log(`Сумма кредита: ${loanAmount.toLocaleString('eu-RU')} руб.`)
console.log(`Годовая ставка: ${annualRate}%`)
console.log(`Срок кредита: ${loanTerm} месяцев`)
console.log(
  `Ежемесячный платеж: ${monthlyPayment.toLocaleString('ru-RU')} руб.`
)
...
console.log(
  `Доход после налога: ${(income - tax).toLocaleString('ru-RU')} руб.`
)
